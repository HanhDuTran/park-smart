...
export function LocateButton({ map, location }: LocateButtonProps) {
  ...
  return (
    <button
      ...
      className="absolute bottom-[calc(56px_+_env(safe-area-inset-bottom)_+_8px)] right-16 z-30 flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-surface text-primary-light shadow-2xl shadow-black/50 backdrop-blur-glass transition-transform duration-150 hover:scale-105 hover:text-primary active:scale-95 sm:bottom-6 sm:right-20"
    >
